 ...
 * </p>
 * <ul>
 *   <li>{@link ntnu.mde.as2.impl.StudyProgrammeImpl#getStudents <em>Students</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StudyProgrammeImpl extends EntityImpl implements StudyProgramme {
	/**
	...
	protected EClass eStaticClass() {
		return As2Package.Literals.STUDY_PROGRAMME;
	}
	...
	public EList<Student> getStudents() {
		if (students == null) {
			students = new EObjectWithInverseResolvingEList<Student>(Student.class, this,
					As2Package.STUDY_PROGRAMME__STUDENTS, As2Package.STUDENT__ENROLLED_IN);
		}
		return students;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case As2Package.STUDY_PROGRAMME__STUDENTS:
